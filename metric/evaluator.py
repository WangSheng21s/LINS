...
class SumEvaluator:
    def __init__(self, max_length=1024, device='cuda:0', cache_dir=None, model_path = "./model/UniEval/unieval-sum"):
        ...
        self.scorer = UniEvaluator(model_name_or_path=model_path, 
...
class DialogEvaluator:
    def __init__(self, max_length=1024, device='cuda:0', cache_dir=None, model_path='MingZhong/unieval-dialog'):
...
def get_evaluator(task, max_length=1024, device='cuda:0', cache_dir=None, model_path=None):
